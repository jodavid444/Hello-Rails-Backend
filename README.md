...
```sh
git clone https://github.com/jodavid444/Hello-Rails-Backend.git
...
This project is [Apache](https://github.com/jodavid444/Hello-rails-react/blob/development/LICENSE) licensed.
